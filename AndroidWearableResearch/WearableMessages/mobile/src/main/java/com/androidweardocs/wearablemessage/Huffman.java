...
public class Huffman {
    ...
    public static void compress() {
        // read the input
        StringData mStringData = new StringData();
        String s = mStringData.STRING_DATA;//BinaryStdIn.readString();
    ...
    public static void main(String[] args) {
        ...
        PrintWriter mPrintWriter= StdOut.out;
        DecoratedWriter mDecoratedWriter = new DecoratedWriter(mPrintWriter);
         */
//        args[0] = "-";
//        args[1] = "ksjdfhksdjfhsdkf";
